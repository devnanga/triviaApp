...
export default function TriviaHard() {
    ...
    function nextSong() {
        ...
        const text = song.lyrics_snippet.slice(0, 60);
        setSnippet(text);
    }
    ...
    return (
        <div style={{ textAlign: "center", marginTop: "3rem" }}>
            <HomeButton />
            <h2>Trivia Game 2 - Hard (60 chars)</h2>
            <p>Score: {score}</p>
                ...
                {artistSuggestions.length > 0 && (
                    <div style={{ position: "absolute", background: "#fff", border: "1px solid #ccc", width: "200px", maxHeight: "120px", overflowY: "auto", zIndex: 10 }}>
                        {artistSuggestions.map((a) => (
                            <div key={a} style={{ padding: "4px", cursor: "pointer" }} o onMouseDown={() => {
                                setArtistGuess(a);
